...
Finally, remember that authentication is not the same thing as secure channel communications. You may turn authentication, but endpoints that aren't talking secure CIP would be vulnerable.